        ...
        bot.commands.bronksKomenda = { //ogólnie musi być bot.commands.jakasunikalnanazwa = {
            ...
            functionality: function (chat, cmd) {
                ...
                if (!bot.commands.executable(this.rank, chat)) return void (0); //nie odpala komendy jesli uzytkownik nie ma odpowiedniej rangi
                	...
                	//kod jaki bot wykonuje, dowolny JS, korzystaj z front-end API plugdj
                    API.sendChat("/me Wielki człowiek, dumny obywatel Polski. Jeden z najlepszych moderatorów i administartorów. Genialny gracz lola. Po wydarzeniach z  24 stycznia 2012 roku opuścił nasze państwo (to wtedy Sosnowiec wyemigrował z Polski). Powitajmy @xBronks"); //wysyla wiadomosc
